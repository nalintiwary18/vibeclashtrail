...
export default function Home() {
    return (
        <div className="bg-black">
            ...
            <div className="min-h-screen overflow-clip bg-black flex flex-col items-center justify-start relative w-full pt-14 pb-4 px-0" id={"home"}>
                <div className="relative z-10 flex flex-col items-center gap-0 sm:gap-2">
                    <Image
                        src="/logo.png"
                        alt="logo"
                        width={300}
                        height={300}
                        className="relative z-20 w-28 sm:w-36 md:w-44 lg:w-56 h-auto"
                    />
                    <Image
                        src="/Heading.png"
                        alt="heading"
                        width={800}
                        height={800}
                        className="relative z-20 w-full max-w-[240px] sm:max-w-md md:max-w-lg lg:max-w-lg h-auto"
                    />
                </div>
                <div className="relative w-full my-2 sm:my-6">
                    <Image
                        src="/USAR.png"
                        width={2000}
                        height={500}
                ...
                <div className="relative z-20 flex flex-col items-center gap-2 sm:gap-3" style={{marginTop: '-10%'}}>
